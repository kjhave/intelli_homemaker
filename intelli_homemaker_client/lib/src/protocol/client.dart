...
import 'package:intelli_homemaker_client/src/protocol/greetings/greeting.dart'
    as _i7irfuiq;
...
class EndpointGreeting extends _isc.EndpointRef {
  ...
  _ida.Future<_i7irfuiq.Greeting> hello(String name) =>
      caller.callServerEndpoint<_i7irfuiq.Greeting>(
        'greeting',
        'hello',
        {'name': name},
      );
